...
foreach(TOOLNAME gcc g++ ld ar ranlib strip nm)
	configure_file(${CMAKE_CURRENT_SOURCE_DIR}/toolchains/bb10/tool_wrapper.cmake ${CMAKE_CURRENT_BINARY_DIR}/${LINPHONE_BUILDER_TOOLCHAIN_HOST}-${TOOLNAME})
endforeach(TOOLNAME)

set(LINPHONE_BUILDER_TOOLCHAIN_CC "${CMAKE_CURRENT_BINARY_DIR}/${LINPHONE_BUILDER_TOOLCHAIN_HOST}-gcc")
set(LINPHONE_BUILDER_TOOLCHAIN_CXX "${CMAKE_CURRENT_BINARY_DIR}/${LINPHONE_BUILDER_TOOLCHAIN_HOST}-g++")
