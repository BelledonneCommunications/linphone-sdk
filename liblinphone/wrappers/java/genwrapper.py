...
class ProvisioningConfigurationKey:
    def __init__(self):
        pass
...
class GenWrapper:
    def __init__(self, srcdir, javadir, javadocdir, package, xmldir, exceptions, upload_dir, version, platform):
        ...
        self.provisioning_configuration_key = ProvisioningConfigurationKey()
    ...
    def render_all(self):
        ...
        self.render(self.provisioning_configuration_key, self.javadocdir + '/provisioning_configuration_key.html')
...
if __name__ == '__main__':
    ...
    argparser.add_argument('-n --name', type=str, help='the name of the generated source file', dest='name', default='linphone_jni.cc')
