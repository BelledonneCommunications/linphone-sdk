...
/**
 * Sets the #LinphoneLdapParams used by this #LinphoneLdap. The parameters will be saved in the configuration file.
 *
 * @param ldap The #LinphoneLdap object. @notnil
 * @param params The #LinphoneLdapParams object. @notnil
 * @deprecated 18/11/2024 #LinphoneLdap object is no longer used; use #LinphoneRemoteContactDirectory instead.
 ...
 * make your changes on it, and apply them using linphone_ldap_set_params().
 * @param ldap The #LinphoneLdap object. @notnil
 * @return The #LinphoneLdapParams attached to this #LinphoneLdap. @notnil
 * @deprecated 18/11/2024 #LinphoneLdap object is no longer used; use #LinphoneRemoteContactDirectory instead.
 */
 ...
 * @param ldap The #LinphoneLdap object. @notnil
 * @return The #LinphoneCore object to which the #LinphoneLdap is associated. @notnil
 * @deprecated 18/11/2024 #LinphoneLdap object is no longer used; use #LinphoneRemoteContactDirectory instead.
 */
