...
class ConferenceCbs : public bellesip::HybridObject<LinphoneConferenceCbs, ConferenceCbs>, public ListenerBase {
public:
	...
	LinphoneConferenceCbsOperationFailedCb operationFailedCb;
