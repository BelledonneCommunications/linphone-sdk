...
if (UNIX)
	if(APPLE)
		if(CMAKE_OSX_DEPLOYMENT_TARGET)
			set(LINPHONE_BUILDER_CPPFLAGS "${LINPHONE_BUILDER_CPPFLAGS} -mmacosx-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET}")
		endif()
		if(CMAKE_OSX_ARCHITECTURES)
			set(LINPHONE_BUILDER_CPPFLAGS "${LINPHONE_BUILDER_CPPFLAGS} -arch ${CMAKE_OSX_ARCHITECTURES}")
		endif()
		set(LINPHONE_BUILDER_OBJCFLAGS ${LINPHONE_BUILDER_CPPFLAGS})
		set(LINPHONE_BUILDER_LDFLAGS ${LINPHONE_BUILDER_LDFLAGS})
	else()
