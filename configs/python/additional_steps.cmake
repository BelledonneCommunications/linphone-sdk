...
ExternalProject_Add(TARGET_pylinphone
	...
	CMAKE_ARGS ${LINPHONE_BUILDER_EP_ARGS} -DPACKAGE_NAME=${PACKAGE_NAME} -DLINPHONE_SOURCE_DIR=${EP_linphone_SOURCE_DIR} -DLINPHONE_BUILDER_PYTHON_VERSION=${LINPHONE_BUILDER_PYTHON_VERSION} -DENABLE_FFMPEG:BOOL=${ENABLE_FFMPEG} -DENABLE_OPENH264:BOOL=${ENABLE_OPENH264}
)
