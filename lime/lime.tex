...
\begin{versionhistory}
  \vhEntry{\currentVersion}{Feb 27, 2025}{JP}{Update PQC description with MLKem and add multialgo support}
  \vhEntry{1.1}{June 15, 2024}{JP}{Add support to Post-Quantum Cryptography}
...
\paragraph{}Lime is written in C\nolinebreak\hspace{-.05em}\raisebox{.4ex}{\tiny\bf +}\nolinebreak\hspace{-.10em}\raisebox{.4ex}{\tiny\bf +}17 and the library uses templates to provide support for Curve25519, Curve448 and hybrids Curve25519/Kyber512, Curve25519/MLKem512, Curve448/MLKem1024 based cryptographic algorithms. The library supports one or several cryptographics bases according to build settings.
