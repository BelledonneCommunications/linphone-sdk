    ...
    \subsubsection{RatchetEncrypt}
      ...
      \paragraph*{}with following functions definitions:
        \begin{algorithmic}
          ...
          \EndFunction
        \end{algorithmic}
      \paragraph*{Notes:}HKDFSha512Expansion implements one round of the HKDF expansion defined in \cite{rfc5869}.\\*Header function is specified in section \ref{subsec:protocol_doubleratchet}
