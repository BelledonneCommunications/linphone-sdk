 ...
 *
 *  8-Jan-2005    Fixed reporting bug (bug report bcunit-Bugs-1093861).  (JDS)
 *
...
bcunit_trace_handler_t CU_trace_handler = NULL;

void CU_set_trace_handler(bcunit_trace_handler_t handler)
{
 ...
 *  done.  If NULL, the default BCUnit test registry will be used.
