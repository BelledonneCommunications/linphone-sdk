...
static void test_cacheless_exchange(void) {
	...
	cryptoParams_t kem_patterns[] = {
		{{ZRTP_CIPHER_AES3},1,{ZRTP_HASH_S512},1,{ZRTP_KEYAGREEMENT_MLK1},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_GCM},1,0},
		{{ZRTP_CIPHER_AES3},1,{ZRTP_HASH_S512},1,{ZRTP_KEYAGREEMENT_MLK2},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_GCM},1,0},
		{{ZRTP_CIPHER_AES3},1,{ZRTP_HASH_S512},1,{ZRTP_KEYAGREEMENT_MLK3},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_GCM},1,0},
	...
	cryptoParams_t hybrid_kem_patterns[] = {
		{{ZRTP_CIPHER_AES3},1,{ZRTP_HASH_S512},1,{ZRTP_KEYAGREEMENT_K255_MLK512},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_GCM},1,0},
		...
		{{ZRTP_CIPHER_AES3},1,{ZRTP_HASH_S512},1,{ZRTP_KEYAGREEMENT_K448_MLK1024},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_GCM},1,0},
...
static void test_config_contraints(void) {
	...
	cryptoParams_t post_quantum_patterns[] = {
		{{ZRTP_CIPHER_AES1},1,{ZRTP_HASH_S256},1,{ZRTP_KEYAGREEMENT_MLK1},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_HS32},1,0},
		...
		{{ZRTP_CIPHER_AES1},1,{ZRTP_HASH_S256},1,{ZRTP_KEYAGREEMENT_MLK3},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_HS32},1,0},
		...
		{{ZRTP_CIPHER_AES1},1,{ZRTP_HASH_S256},1,{ZRTP_KEYAGREEMENT_K255_MLK512},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_HS32},1,0},
		...
		{{ZRTP_CIPHER_AES1},1,{ZRTP_HASH_S256},1,{ZRTP_KEYAGREEMENT_K448_MLK1024},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_HS32},1,0},
	...
	cryptoParams_t expected_post_quantum_patterns[] = {
		{{ZRTP_CIPHER_AES3},1,{ZRTP_HASH_S512},1,{ZRTP_KEYAGREEMENT_MLK1},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_HS32},1,0},
		...
		{{ZRTP_CIPHER_AES3},1,{ZRTP_HASH_S512},1,{ZRTP_KEYAGREEMENT_MLK3},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_HS32},1,0},
		...
		{{ZRTP_CIPHER_AES3},1,{ZRTP_HASH_S512},1,{ZRTP_KEYAGREEMENT_K255_MLK512},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_HS32},1,0},
		...
		{{ZRTP_CIPHER_AES3},1,{ZRTP_HASH_S512},1,{ZRTP_KEYAGREEMENT_K448_MLK1024},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_HS32},1,0},
...
static void test_mtu(void) {
	...
	cryptoParams_t hybrid_kem_patterns[] = {
		{{ZRTP_CIPHER_AES3},1,{ZRTP_HASH_S512},1,{ZRTP_KEYAGREEMENT_K255_MLK512},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_HS80},1,0},
		...
		{{ZRTP_CIPHER_AES3},1,{ZRTP_HASH_S512},1,{ZRTP_KEYAGREEMENT_K448_MLK1024},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_HS80},1,0},
...
static void test_loosy_network_mtu(void) {
	...
	resetGlobalParams();
	srand((unsigned int)time(NULL));
	cryptoParams_t pattern = {{ZRTP_CIPHER_AES3},1,{ZRTP_HASH_S512},1,{ZRTP_KEYAGREEMENT_K448_MLK1024},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_HS80},1,0};
...
static void test_cache_enabled_exchange(void) {
	...
	if (bctbx_key_agreement_algo_list()&BCTBX_KEM_MLKEM512) {
		cryptoParams_t cryptoParams = {{ZRTP_CIPHER_AES3},1,{ZRTP_HASH_S512},1,{ZRTP_KEYAGREEMENT_K255_MLK512},1,{ZRTP_SAS_B32},1,{ZRTP_AUTHTAG_HS32},1,0};
