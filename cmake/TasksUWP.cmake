...
foreach(_UWP_ARCH IN LISTS _UWP_ARCHS)
  add_custom_target(uwp-${_UWP_ARCH} ALL
    COMMAND ${CMAKE_COMMAND} --preset=uwp-${_UWP_ARCH} ${_CMAKE_CONFIGURE_ARGS} ${_UWP_CMAKE_ARGS}
    COMMAND ${CMAKE_COMMAND} --build --preset=uwp-${_UWP_ARCH} --target install ${_CMAKE_BUILD_ARGS}
...
foreach(_UWP_ARCH IN LISTS _UWP_ARCHS)
  ExternalProject_add(uwp-wrapper-${_UWP_ARCH}
		...
		BINARY_DIR "${PROJECT_BINARY_DIR}-${_UWP_ARCH}/CsWrapper"
