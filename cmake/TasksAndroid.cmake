...
if(ANDROID_BUNDLED)
  set(ANDROID_PRESET_PREFIX "bundled-")
endif()
...
foreach(_ANDROID_ARCH IN LISTS _ANDROID_ARCHS)
  ...
  add_custom_target(android-${_ANDROID_ARCH} ALL
    COMMAND ${CMAKE_COMMAND} --preset=${ANDROID_PRESET_PREFIX}android-${_ANDROID_ARCH} -B ${_ANDROID_ARCH_BINARY_DIR} ${_CMAKE_CONFIGURE_ARGS} ${_ANDROID_CMAKE_ARGS} -DCMAKE_INSTALL_PREFIX=${_ANDROID_ARCH_INSTALL_DIR}
