...
add_custom_target(jazzy-doc ALL
	"${CMAKE_COMMAND}" "-DENABLE_SWIFT_WRAPPER=${ENABLE_SWIFT_WRAPPER}" "-DENABLE_JAZZY_DOC=${ENABLE_JAZZY_DOC}" "-DLINPHONESDK_BUILD_DIR=${CMAKE_BINARY_DIR}" "-DENABLE_SWIFT_WRAPPER_COMPILATION=${ENABLE_SWIFT_WRAPPER_COMPILATION}" "-DLINPHONESDK_IOS_ARCHS=${_archs}"
	"-P" "${LINPHONESDK_DIR}/liblinphone/wrappers/swift/jazzydoc.cmake"
	COMMENT "Generating jazzy doc for swift module"
	DEPEND ${_ios_build_targets}
)
