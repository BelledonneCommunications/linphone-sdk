...
foreach(_MACOS_ARCH IN LISTS _MACOS_ARCHS)
  add_custom_target(mac-${_MACOS_ARCH} ALL
    COMMAND ${CMAKE_COMMAND} --preset=mac-${_MACOS_ARCH} ${_CMAKE_CONFIGURE_ARGS} ${_MACOS_CMAKE_ARGS}
    COMMAND ${CMAKE_COMMAND} --build --preset=mac-${_MACOS_ARCH} --target install ${_CMAKE_BUILD_ARGS}
    DEPENDS clean-sdk
