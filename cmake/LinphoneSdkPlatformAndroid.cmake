...
add_custom_target(copy-libs ALL
	"${CMAKE_COMMAND}" "-DLINPHONESDK_DIR=${LINPHONESDK_DIR}" "-DLINPHONESDK_BUILD_DIR=${CMAKE_BINARY_DIR}" "-DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}" "-DLINPHONESDK_ANDROID_ARCHS=${LINPHONESDK_ANDROID_ARCHS}" "-P" "${LINPHONESDK_DIR}/cmake/Android/CopyLibs.cmake"
	COMMENT "Copying libs"
	DEPENDS ${_android_build_targets}
)

add_custom_target(sdk
	"${CMAKE_COMMAND}" "-DLINPHONESDK_DIR=${LINPHONESDK_DIR}" "-DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}" "-DLINPHONESDK_BUILD_DIR=${CMAKE_BINARY_DIR}" "-P" "${LINPHONESDK_DIR}/cmake/Android/GenerateSDK.cmake"
