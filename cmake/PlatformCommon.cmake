...
if(GIT_EXECUTABLE)
	...
	if(DEFINED LINPHONE_SDK_HOOKS_DIR AND EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${LINPHONE_SDK_HOOKS_DIR}")
		file(COPY_FILE "${CMAKE_CURRENT_SOURCE_DIR}/cmake/hook/pre-commit" "${CMAKE_CURRENT_SOURCE_DIR}/${LINPHONE_SDK_HOOKS_DIR}/pre-commit" ONLY_IF_DIFFERENT)
	endif()
endif()
