...
static void nickname_property(void) {
	...
	BC_ASSERT_TRUE_FATAL(nickname != NULL);
	stringstream sstream;
	sstream << *nickname;
	BC_ASSERT_EQUAL(input.compare(sstream.str()), 0, int, "%d");
}
