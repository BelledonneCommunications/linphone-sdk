...
static void key_property(void) {
	...
	test_property<BelCardKey>(
	    "KEY:data:application/"
	    "pgp-keys;base64,MIICajCCAdOgAwIBAgICBEUwDQYJKoZIhvcNAQEEBQAwdzELMAkGA1UEBhMCVVMxLDAqBgNVBAoTI05l\r\n");
}
...
test_suite_t vcard_security_properties_test_suite = {
    "Security", NULL, NULL, NULL, NULL, sizeof(tests) / sizeof(tests[0]), tests};
