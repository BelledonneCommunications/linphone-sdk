...
template <typename T>
bctbx_map_t *bctbx_mmap_new(void) {
...
template <typename T>
void bctbx_mmap_delete(bctbx_map_t *mmap) {
	delete (T *)mmap;
}
...
template <typename T>
bctbx_iterator_t *bctbx_map_insert_base(bctbx_map_t *map, const bctbx_pair_t *pair, bool_t returns_it) {
...
template <typename T>
bctbx_iterator_t *bctbx_map_erase_type(bctbx_map_t *map, bctbx_iterator_t *it) {
...
template <typename T>
bctbx_iterator_t *bctbx_map_begin_type(const bctbx_map_t *map) {
...
template <typename T>
bctbx_iterator_t *bctbx_map_end_type(const bctbx_map_t *map) {
...
template <typename T>
bctbx_iterator_t *bctbx_map_find_key_type(const bctbx_map_t *map, typename T::key_type key) {
...
template <typename T>
size_t bctbx_map_size_type(const bctbx_map_t *map) {
	return ((T *)map)->size();
}
...
/*iterator*/
template <typename T>
bctbx_pair_t *bctbx_iterator_get_pair_type(const bctbx_iterator_t *it) {
...
template <typename T>
bctbx_iterator_t *bctbx_iterator_get_next_type(bctbx_iterator_t *it) {
...
template <typename T>
bool_t bctbx_iterator_equals_type(const bctbx_iterator_t *a, const bctbx_iterator_t *b) {
...
template <typename T>
void bctbx_iterator_delete_type(bctbx_iterator_t *it) {
...
/*pair*/
template <typename T>
typename T::value_type *bctbx_pair_new(typename T::key_type key, void *value) {
...
template <typename T>
const typename T::key_type &bctbx_pair_get_first(const typename T::value_type *pair) {
...
template <typename T>
void *bctbx_pair_get_second_type(const bctbx_pair_t *pair) {
...
template <typename T>
void bctbx_pair_delete_type(bctbx_pair_t *pair) {
	delete ((T *)pair);
}
