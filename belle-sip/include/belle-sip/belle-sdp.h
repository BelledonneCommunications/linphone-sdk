...
belle_sdp_phone_t* belle_sdp_phone_new();
belle_sdp_phone_t* belle_sdp_phone_parse (const char* phone);
const char* belle_sdp_phone_get_value(const belle_sdp_phone_t* phone);
void belle_sdp_phone_set_value(belle_sdp_phone_t* phone, const char* value);
...
belle_sdp_repeate_time_t* belle_sdp_repeate_time_new();
belle_sdp_repeate_time_t* belle_sdp_repeate_time_parse (const char* repeate_time);
const char* belle_sdp_repeate_time_get_value(const belle_sdp_repeate_time_t* repeate_time);
void belle_sdp_repeate_time_set_value(belle_sdp_repeate_time_t* repeate_time, const char* value);
...
belle_sdp_uri_t* belle_sdp_uri_new();
belle_sdp_uri_t* belle_sdp_uri_parse (const char* uri);
const char* belle_sdp_uri_get_value(const belle_sdp_uri_t* uri);
void belle_sdp_uri_set_value(belle_sdp_uri_t* uri, const char* value);
