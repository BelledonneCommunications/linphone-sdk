...
BELLESIP_EXPORT belle_sip_request_t *belle_sip_request_create(belle_sip_uri_t *requri,
                                                              const char *method,
...
BELLESIP_EXPORT belle_sip_header_t *belle_sip_message_get_header(const belle_sip_message_t *msg,
                                                                 const char *header_name);
BELLESIP_EXPORT int belle_sip_header_supported_contains_tag(const belle_sip_header_supported_t *supported,
                                                            const char *tag);

BELLESIP_EXPORT belle_sip_object_t *_belle_sip_message_get_header_by_type_id(const belle_sip_message_t *message,
...
BELLESIP_EXPORT const belle_sip_list_t *belle_sip_message_get_headers(const belle_sip_message_t *message,
                                                                      const char *header_name);
/**
...
BELLESIP_EXPORT void belle_sip_message_set_body_handler(belle_sip_message_t *msg,
 ...
 * */
BELLESIP_EXPORT int belle_sip_response_fix_contact(const belle_sip_response_t *response,
