...
belle_generic_uri_marshal(const belle_generic_uri_t *uri, char *buff, size_t buff_size, size_t *offset) {
...
SET_ESCAPED_STRING(belle_generic_uri, user)
GET_SET_STRING(belle_generic_uri, user_password);
SET_ESCAPED_STRING(belle_generic_uri, user_password)
GET_SET_STRING(belle_generic_uri, host);
GET_SET_STRING(belle_generic_uri, path);
SET_ESCAPED_STRING(belle_generic_uri, path);
GET_SET_STRING(belle_generic_uri, query);
SET_ESCAPED_STRING(belle_generic_uri, query)
...
BELLE_PARSE(belle_, generic_uri, false)
