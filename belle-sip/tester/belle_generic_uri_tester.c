...
static void test_complex_uri(void) {
	...
	belle_generic_uri_t *source_uri = belle_generic_uri_parse(
	    "ftp://toto:secret@ftp.linphone.fr:1234/url?sa=t&rct=j&url=http%3A%2F%2Ftranslate.google.fr");
...
static test_t tests[] = {TEST_NO_TAG("Simple uri", test_basic_uri), TEST_NO_TAG("Complex uri", test_complex_uri),
                         TEST_NO_TAG("File path", test_file_path), TEST_NO_TAG("Absolute uri", test_absolute_uri)};

test_suite_t generic_uri_test_suite = {"Generic uri",
                                       NULL,
                                       NULL,
