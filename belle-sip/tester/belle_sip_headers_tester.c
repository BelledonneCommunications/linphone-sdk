...
static void test_from_header(void) {
	...
	belle_sip_header_from_t *L_from =
	    belle_sip_header_from_parse("f:<sip:titi.com;transport=tcp>;tag=dlfjklcn6545614XX");
	...
	// Test factory
	L_from = belle_sip_header_from_create2(
	    "super <sip:titi.com:5060;lr;ttl=1;method=INVITE;maddr=192.168.0.1;transport=tcp?header=123>", "12345-abc");
...
static void test_to_header(void) {
	belle_sip_uri_t *L_uri;
	belle_generic_uri_t *L_absoluteUri;
	belle_sip_header_to_t *L_tmp,
	    *L_to = belle_sip_header_to_parse("t : < sip:titi.com;transport=tcp> ; tag = dlfjklcn6545614XX");
	...
	belle_sip_object_unref(BELLE_SIP_OBJECT(L_to));
	/*test factory*/
	L_to = belle_sip_header_to_create2(
	    "\"super man\" <sip:titi.com:5060;lr;ttl=1;method=INVITE;maddr=192.168.0.1;transport=tcp?header=123>",
	    "12345-abc");
...
static void test_via_header(void) {
	...
	belle_sip_header_via_t *L_via =
	    belle_sip_header_via_parse("v: SIP/2.0/UDP [::1]:5062;rport;received=::1;branch=z9hG4bK368560724");
	...
	L_via = belle_sip_header_via_parse(
	    "Via: SIP/2.0/UDP 192.168.0.19:5062;received=192.169.0.4;rport=1234;branch=z9hG4bK368560724, SIP/2.0/UDP "
	    "192.168.0.19:5062");
...
static void test_content_type_header(void) {
	...
	belle_sip_header_content_type_t *L_content_type =
	    belle_sip_header_content_type_parse("c: text/html; charset=ISO-8859-4");
	...
	BC_ASSERT_STRING_EQUAL(belle_sip_parameters_get_parameter(BELLE_SIP_PARAMETERS(L_content_type), "charset"),
	                       "ISO-8859-4");
	belle_sip_object_unref(BELLE_SIP_OBJECT(L_content_type));
	...
	L_content_type = belle_sip_header_content_type_parse(
	...
	BC_ASSERT_STRING_EQUAL(belle_sip_parameters_get_parameter(BELLE_SIP_PARAMETERS(L_content_type), "type"),
...
static void test_record_route_header(void) {
	...
	belle_sip_header_record_route_t *L_record_route =
	    belle_sip_header_record_route_parse("Record-Route: <sip:212.27.52.5:5060;transport=udp;lr>;charset=ISO-8859-4");
	...
	BC_ASSERT_STRING_EQUAL(belle_sip_parameters_get_parameter(BELLE_SIP_PARAMETERS(L_record_route), "charset"),
	                       "ISO-8859-4");
	belle_sip_object_unref(BELLE_SIP_OBJECT(L_record_route));
...
static void test_route_header(void) {
	...
	L_route = belle_sip_header_route_parse(
...
static void test_service_route_header(void) {
	belle_sip_header_service_route_t *L_service_route =
	    belle_sip_header_service_route_parse("Service-Route: <sip:orig@scscf.ims.linphone.com:6060;lr>");
	belle_sip_uri_t *L_uri;
	char *l_raw_header;
...
static void test_content_length_header(void) {
	...
	belle_sip_object_unref(BELLE_SIP_OBJECT(L_tmp));
	belle_sip_free(l_raw_header);
	BC_ASSERT_EQUAL((unsigned int)belle_sip_header_content_length_get_content_length(L_content_length), 3495,
	                unsigned int, "%u");
	belle_sip_object_unref(BELLE_SIP_OBJECT(L_content_length));
...
static void test_authorization_header(void) {
	const char *l_header = "Authorization: Digest username=\"0033482532176\", "
	                       "realm=\"sip.ovh.net\", nonce=\"1bcdcb194b30df5f43973d4c69bdf54f\", "
	                       "uri=\"sip:sip.ovh.net\", response=\"eb36c8d5c8642c1c5f44ec3404613c81\","
	...
	BC_ASSERT_STRING_EQUAL(belle_sip_header_authorization_get_nonce(L_authorization),
	                       "1bcdcb194b30df5f43973d4c69bdf54f");
	BC_ASSERT_PTR_NOT_NULL(belle_sip_header_authorization_get_uri(L_authorization));
	BC_ASSERT_STRING_EQUAL(belle_sip_header_authorization_get_response(L_authorization),
...
static void test_proxy_authorization_header(void) {
	...
	BC_ASSERT_STRING_EQUAL(belle_sip_header_authorization_get_username(BELLE_SIP_HEADER_AUTHORIZATION(L_authorization)),
	                       "Alice");
	BC_ASSERT_STRING_EQUAL(belle_sip_header_authorization_get_realm(BELLE_SIP_HEADER_AUTHORIZATION(L_authorization)),
	                       "atlanta.com");
	BC_ASSERT_STRING_EQUAL(belle_sip_header_authorization_get_nonce(BELLE_SIP_HEADER_AUTHORIZATION(L_authorization)),
...
static void test_www_authenticate_header(void) {
	...
	const char *l_header_1 =
	    "WWW-Authenticate: Digest realm=\"toto.com\",\r\n   nonce=\"b543409177c9036dbf3054aea940e9703dc8f84c0108\""
	...
	BC_ASSERT_PTR_NOT_NULL(l_authenticate =
	                           BELLE_SIP_HEADER_WWW_AUTHENTICATE(belle_sip_header_get_next(BELLE_SIP_HEADER(L_tmp))));
...
static void test_proxy_authenticate_header(void) {
	...
	BC_ASSERT_STRING_EQUAL(belle_sip_header_www_authenticate_get_algorithm(BELLE_SIP_HEADER_WWW_AUTHENTICATE(L_tmp)),
	                       "MD5");
	BC_ASSERT_PTR_NOT_NULL(L_proxy_authenticate =
	                           BELLE_SIP_HEADER_PROXY_AUTHENTICATE(belle_sip_header_get_next(BELLE_SIP_HEADER(L_tmp))));
	BC_ASSERT_STRING_EQUAL(
	    belle_sip_header_www_authenticate_get_algorithm(BELLE_SIP_HEADER_WWW_AUTHENTICATE(L_proxy_authenticate)),
	    "SHA-256");
	belle_sip_object_unref(BELLE_SIP_OBJECT(L_tmp));
...
static void test_user_agent_header(void) {
	...
	const char *values[] = {"Linphone/3.4.99.1", "(eXosip2/3.3.0)"};
...
static void test_allow_header(void) {
	...
	belle_sip_header_allow_t *L_allow = belle_sip_header_allow_parse(
	...
	BC_ASSERT_STRING_EQUAL(belle_sip_header_allow_get_method(L_allow),
...
static void test_address_header(void) {
	...
	belle_sip_header_address_t *laddress =
	    belle_sip_header_address_fast_parse("\"toto\" <sip:liblinphone_tester@81.56.11.2:5060>");
	...
	laddress = belle_sip_header_address_parse(L_raw);
	belle_sip_free(L_raw);
	BC_ASSERT_STRING_EQUAL("sip1.example.com",
	                       belle_sip_uri_get_maddr_param(belle_sip_header_address_get_uri(laddress)));
	belle_sip_object_unref(BELLE_SIP_OBJECT(laddress));
}
static void test_address_header_with_params(void) {
	...
	belle_sip_header_address_t *laddress =
	    belle_sip_header_address_fast_parse("\"toto\" <sip:liblinphone_tester@81.56.11.2:5060> ; toto=\"titi\";tutu");
	BC_ASSERT_PTR_NOT_NULL(laddress);
	L_raw = belle_sip_object_to_string(BELLE_SIP_OBJECT(lclonedaddr = belle_sip_header_address_clone(laddress)));
	BC_ASSERT_PTR_NOT_NULL(L_raw);
	belle_sip_object_unref(BELLE_SIP_OBJECT(laddress));
...
static void test_address_header_with_session_expires(void) {
	...
	belle_sip_header_session_expires_t *L_session_expires_tmp =
	    belle_sip_header_session_expires_parse("Session-Expires: 4000;refresher=uac");
	belle_sip_header_session_expires_t *L_session_expires =
	    BELLE_SIP_HEADER_SESSION_EXPIRES(belle_sip_object_clone(BELLE_SIP_OBJECT(L_session_expires_tmp)));

	BC_ASSERT_EQUAL(belle_sip_header_session_expires_get_delta(L_session_expires), 4000, int, "%d");
	BC_ASSERT_EQUAL(belle_sip_header_session_expires_get_refresher_value(L_session_expires),
	                BELLE_SIP_HEADER_SESSION_EXPIRES_UAC, int, "%d");
	...
	BC_ASSERT_EQUAL(belle_sip_header_session_expires_get_refresher_value(L_session_expires),
	                BELLE_SIP_HEADER_SESSION_EXPIRES_UAS, int, "%d");
...
static void test_very_long_address_header(void) {
	...
	const char *raw = "<sip:jehan@sip.linphone.org"
	                  ";app-id=622464153529"
	                  "; pn-type=google"
	                  ";pn-tok=APA91bHPVa4PuKOMnr6ppWb3XYUL06QO-ND4eeiw7dG49q4o_Ywzal7BxVRgH-wvqH9iB9V7h6kfb-"
	                  "DCiVdSpnl6CeWO25FAkM4eh6DJyWcbP7SzhKdku_-r9936kJW7-4drI6-Om4qp"
	                  ";pn-msg-str=IM_MSG "
	                  ";pn-call-str=IC_MSG"
	...
	do {
		...
		const char *cexpected = ("APA91bHPVa4PuKOMnr6ppWb3XYUL06QO-ND4eeiw7dG49q4o_Ywzal7BxVRgH-wvqH9iB9V7h6kfb-"
		                         "DCiVdSpnl6CeWO25FAkM4eh6DJyWcbP7SzhKdku_-r9936kJW7-4drI6-Om4qp");
		sprintf(format,
		        "name"
		        "("
	...
	BC_ASSERT_STRING_EQUAL(belle_sip_parameters_get_parameter(BELLE_SIP_PARAMETERS(L_uri), "pn-tok"),
	                       "APA91bHPVa4PuKOMnr6ppWb3XYUL06QO-ND4eeiw7dG49q4o_Ywzal7BxVRgH-wvqH9iB9V7h6kfb-"
	                       "DCiVdSpnl6CeWO25FAkM4eh6DJyWcbP7SzhKdku_-r9936kJW7-4drI6-Om4qp");
	belle_sip_object_unref(BELLE_SIP_OBJECT(laddress));
}
...
static void test_subscription_state_header(void) {
	...
	belle_sip_header_subscription_state_t *L_subscription_state =
	    belle_sip_header_subscription_state_parse("Subscription-State: terminated;expires=600");
...
static void test_refer_to_header(void) {
	...
	belle_sip_header_refer_to_t *L_refer_to = belle_sip_header_refer_to_parse(
	    "Refer-To: "
...
static void test_referred_by_header(void) {
	belle_sip_uri_t *L_uri;
	belle_sip_header_referred_by_t *L_referred_by =
	    belle_sip_header_referred_by_parse("Referred-By: sip:r@ref.example;cid=\"2UWQFN309shb3@ref.example\"");
...
static void test_replaces_header(void) {
	...
	belle_sip_header_replaces_t *L_replaces =
	    belle_sip_header_replaces_parse("Replaces: 12345@149.112.118.3;to-tag=12345;from-tag=54321");
...
static void
test_require(const char *header_name, const char *header_value, const char *values[], size_t number_values) {
	belle_sip_list_t *list;
	belle_sip_header_require_t *L_tmp;
	belle_sip_header_require_t *L_require =
	    BELLE_SIP_HEADER_REQUIRE(belle_sip_header_create(header_name, header_value));
...
static void test_p_preferred_identity_header(void) {
	belle_sip_uri_t *L_uri;
	belle_sip_header_p_preferred_identity_t *L_p_preferred_identity =
	    belle_sip_header_p_preferred_identity_parse("P-Preferred-Identity: \"Cullen Jennings\" <sip:fluffy@cisco.com>");
	...
	BC_ASSERT_STRING_EQUAL(belle_sip_header_address_get_displayname(BELLE_SIP_HEADER_ADDRESS(L_p_preferred_identity)),
	                       "Cullen Jennings");
...
static void
test_supported(const char *header_name, const char *header_value, const char *values[], size_t number_values) {
	belle_sip_list_t *list;
	belle_sip_header_supported_t *L_tmp;
	belle_sip_header_supported_t *L_supported =
	    BELLE_SIP_HEADER_SUPPORTED(belle_sip_header_create(header_name, header_value));
...
static void test_content_disposition_header(void) {
	...
	belle_sip_header_content_disposition_t *L_content_disposition = BELLE_SIP_HEADER_CONTENT_DISPOSITION(
	    belle_sip_header_create("Content-Disposition", "form-data; name=\"File\"; filename=\"toto.jpeg\""));
	...
	BC_ASSERT_STRING_EQUAL(belle_sip_header_content_disposition_get_content_disposition(L_content_disposition),
	                       "form-data");
	BC_ASSERT_STRING_EQUAL(belle_sip_parameters_get_parameter(BELLE_SIP_PARAMETERS(L_content_disposition), "name"),
	                       "\"File\"");
	BC_ASSERT_STRING_EQUAL(belle_sip_parameters_get_parameter(BELLE_SIP_PARAMETERS(L_content_disposition), "filename"),
	                       "\"toto.jpeg\"");
	belle_sip_object_unref(BELLE_SIP_OBJECT(L_content_disposition));
...
static void test_accept_header(void) {
	...
	belle_sip_header_accept_t *L_accept =
	    BELLE_SIP_HEADER_ACCEPT(belle_sip_header_create("Accept", "text/html; charset=ISO-8859-4"));
	...
	L_accept =
	    belle_sip_header_accept_parse("Accept: application/pkcs7-mime; smime-type=enveloped-data; \r\n name=smime.p7m");
	l_raw_header = belle_sip_object_to_string(BELLE_SIP_OBJECT(L_accept));
	belle_sip_object_unref(BELLE_SIP_OBJECT(L_accept));
	L_accept = belle_sip_header_accept_parse(l_raw_header);
	belle_sip_free(l_raw_header);
	...
	L_accept =
	    belle_sip_header_accept_parse("Accept: application/sdp, text/plain, application/vnd.gsma.rcs-ft-http+xml");
	BC_ASSERT_STRING_EQUAL(belle_sip_header_accept_get_type(L_accept), "application");
	BC_ASSERT_STRING_EQUAL(belle_sip_header_accept_get_subtype(L_accept), "sdp");
...
static void test_reason_header(void) {
	...
	belle_sip_header_reason_t *L_reason =
	    BELLE_SIP_HEADER_REASON(belle_sip_header_create("Reason", "Q.850 ;cause=16 ;text=\"Busy Everywhere\""));
	char *l_raw_header;
	...
	L_reason = belle_sip_header_reason_parse(
	    "Reason: SIP ;cause=600 ;text=\"Busy Everywhere\", SIP ;cause=580 ;text=\"Precondition Failure\"");
...
static void test_authentication_info_header(void) {
	...
	belle_sip_header_authentication_info_t *L_authentication_info = BELLE_SIP_HEADER_AUTHENTICATION_INFO(
	    belle_sip_header_create("Authentication-Info", "nextnonce=\"47364c23432d2e131a5fb210812c\""
	                                                   ", qop=auth"));
	char *l_raw_header;

	BC_ASSERT_STRING_EQUAL(belle_sip_header_authentication_info_get_next_nonce(L_authentication_info),
	                       "47364c23432d2e131a5fb210812c");
	...
	BC_ASSERT_STRING_EQUAL(belle_sip_header_authentication_info_get_next_nonce(L_authentication_info),
	                       "31a5fb210812c47364c23432d2e1");
	BC_ASSERT_STRING_EQUAL(belle_sip_header_authentication_info_get_qop(L_authentication_info), "auth");

	belle_sip_object_unref(BELLE_SIP_OBJECT(L_authentication_info));
	belle_sip_free(l_raw_header);

	L_authentication_info = belle_sip_header_authentication_info_parse(
	    "Authentication-Info:nextnonce=\"WRSE5VkUg7kOjnP5sBZZzsxrsOQ8Eyp6ZNttXIA=\", qop=auth , "
	    "rspauth=\"5e8518291c1320989df6966405e0b3d1\", cnonce=\"05bc00e63a7794182f9425da9266d00d\", nc=00000001");
...
test_suite_t headers_test_suite = {"Headers",
                                   NULL,
                                   NULL,
