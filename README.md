...
Import the project : `git clone git@gitlab.linphone.org:BC/public/linphone-sdk.git --recursive sdk`
...
Your package will be in `build/linphone-sdk/desktop` folder. You can use it in the Nuget Packet Manager from Visual Studio.
